...
function Nav() {
  return (
    <div className='p-3 m-3 mx-[55px] flex place-content-between'>
      <Btn href="/Overwatch-randomiser-challenge/#/patchnotes" name="Patch notes"class="font-bold text-white bg-orange hover:bg-orange-dark p-1 rounded-md"/>
      <a href='/Overwatch-randomiser-challenge/#/'>
